...
<span class="hljs-keyword">let</span> identifierBase

<span class="hljs-keyword">const</span> semver = <span class="hljs-built_in">require</span>(<span class="hljs-string">'../'</span>)
<span class="hljs-keyword">const</span> parseOptions = <span class="hljs-built_in">require</span>(<span class="hljs-string">'../internal/parse-options'</span>)
...
<span class="hljs-keyword">const</span> main = <span class="hljs-function"><span class="hljs-params">()</span> =&gt;</span> {
  <span class="hljs-keyword">if</span> (!argv.length) {
  ...
  <span class="hljs-keyword">while</span> (argv.length) {
    ...
    <span class="hljs-keyword">if</span> (indexOfEqualSign !== <span class="hljs-number">-1</span>) {
      <span class="hljs-keyword">const</span> value = a.slice(indexOfEqualSign + <span class="hljs-number">1</span>)
    ...
    <span class="hljs-keyword">switch</span> (a) {
      ...
      <span class="hljs-keyword">case</span> <span class="hljs-string">'-n'</span>:
        ...
        <span class="hljs-keyword">if</span> (identifierBase === <span class="hljs-string">'false'</span>) {
          identifierBase = <span class="hljs-literal">false</span>
        }
        <span class="hljs-keyword">break</span>
  ...
  <span class="hljs-keyword">if</span> (!versions.length) {
  ...
  versions
    .sort(<span class="hljs-function">(<span class="hljs-params">a, b</span>) =&gt;</span> semver[reverse ? <span class="hljs-string">'rcompare'</span> : <span class="hljs-string">'compare'</span>](a, b, options))
    .map(<span class="hljs-function"><span class="hljs-params">v</span> =&gt;</span> semver.clean(v, options))
    .map(<span class="hljs-function"><span class="hljs-params">v</span> =&gt;</span> inc ? semver.inc(v, inc, options, identifier, identifierBase) : v)
