...
<span class="hljs-comment">/* Based on webpack/bin/webpack.js */</span>
...
<p>eslint-disable-next-line no-cond-assign</p>

        </td>
        <td class="code highlight">
          <pre class="javascript">  } <span class="hljs-keyword">while</span> (dir !== (dir = path.dirname(dir)));
...
<span>options
  ...
  <span class="hljs-keyword">if</span> (cli.preprocess) {
    cli.preprocess();
  }
  <span class="hljs-keyword">const</span> path = <span class="hljs-built_in">require</span>(<span class="hljs-string">"path"</span>);
...
<p>eslint-disable-next-line import/no-dynamic-require</p>
...
<span class="hljs-keyword">const</span> cli = {
  ...
  preprocess() {
    process.argv.splice(<span class="hljs-number">2</span>, <span class="hljs-number">0</span>, <span class="hljs-string">"serve"</span>);
  },
};
...
<span class="hljs-keyword">if</span> (!cli.installed) {
  ...
  <span class="hljs-keyword">const</span> notify = <span class="hljs-string">`CLI for webpack must be installed.\n  <span class="hljs-subst">${cli.name}</span> (<span class="hljs-subst">${cli.url}</span>)\n`</span>;
...
<span class="dox_type">string</span>
        ...
        <td class="code highlight">
          <pre class="javascript">  <span class="hljs-keyword">let</span> packageManager;
